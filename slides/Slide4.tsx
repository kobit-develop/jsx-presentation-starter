    ...
    <Fragment flexGrow={1} padding={8} paddingTop={2}>
      ...
      <Fragment flexDirection="row" flexGrow={1}>
        <Fragment flexGrow={1}>
          ...
          <Chart data={chartData} flexGrow={1} marginTop={2} />
        </Fragment>

        <Fragment flexGrow={1}>
          <SubHeader>Sub Header 2</SubHeader>
          <Text {...bodyStyle} flexGrow={1} marginTop={2}>
            Lorem ipsum dolor sit amet, <Text bold>consectetur adipisicing</Text> elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
          </Text>
        </Fragment>
      </Fragment>
    </Fragment>
